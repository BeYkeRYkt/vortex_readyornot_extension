...
Vortex should auto-detect the Steam or Epic version of the game. If it doesn't you'll need to go to `Games > Unmanaged` and 
click on RoN to manually set the location. From there point it to the folder containing `ReadyOrNot.exe` or `ReadyOrNotEGS.exe`.
